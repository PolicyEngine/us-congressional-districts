"""
To see the definitive "before and after" of congressional redistricting following the 2020 census, you should compare the block-level data from the 116th Congress to the 119th Congress.

This approach is necessary for states whose initial redistricting maps were altered due to legal challenges and is aligned with the mapping files provided by the U.S. Census Bureau.

- **116th Congress (The "Before"):** This session (2019-2021) used the congressional maps based on the 2010 census data. It serves as the stable pre-redistricting baseline, as these maps were identical to those used by the 117th Congress. The Census Bureau's most recent files for that decade correspond to the 116th Congress.

- **118th Congress (The "Interim" Stage):** In several states, the initial congressional maps drawn for the 2022 elections were successfully challenged and invalidated by courts (e.g., for reasons of partisan or racial gerrymandering). This required the use of temporary, court-ordered, or remedial maps for the 2022 elections. Consequently, the 118th Congress (2023-2025) in these states represents an interim stage, not the final outcome of the redistricting cycle.

- **119th Congress (The Definitive "After"):** Following these legal resolutions, new and more permanent congressional maps were enacted ahead of the 2024 election cycle. The elections in November 2024 were the first to use these new maps. Therefore, the 119th Congress (2025-2027) is the first to reflect the final, settled mapping decisions based on the 2020 census data.
